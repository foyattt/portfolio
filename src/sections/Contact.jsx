    ...
    <section id="contact" className="contact section">
      <div className="container">
        <SectionHeading
          ...
          description="Open to software engineering opportunities, collaborations, and conversations about building reliable systems."
        />

        <div className="contact__inner">
          <div className="contact__info">
            <p className="contact__intro">
              Whether you are hiring, collaborating, or just want to connect — reach out through
